...
function KHMRaidFrames.componentScale(groupType)
    ...
    local scale = min(
        EditModeManagerFrame:GetRaidFrameHeight() / KHMRaidFrames.NATIVE_UNIT_FRAME_HEIGHT,
        EditModeManagerFrame:GetRaidFrameWidth() / KHMRaidFrames.NATIVE_UNIT_FRAME_WIDTH
    )
